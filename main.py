...
question = "So, I am in Bologna and I am walking in the centre. There is a statue with a fountain. What is this statue?"
...
ans_prompt = PromptTemplate(
    template = """
               ...
               it and take into account only information relevant to the question.
               <context>
               {context}
               </context>
               <|eot_id|><|start_header_id|>user<|end_header_id|>
...
query = siri.invoke({"question": question})
print(query)  
